<template>
  <div>
    <h1>Vue Todo List</h1>
    <input type="text" placeholder="Add a word..." v-model="word">
    ...
    <ul class="filter">
      <li @click="filterArray('all')">All</li>
      <li @click="filterArray('active')">Active</li>
      <li @click="filterArray('complete')">Completed</li>
    </ul>
  </div>
</template>
